    ...
    collections: [
      {
        ...
        items: [
          project('Popy', "Children's book character", 'wide', 'A red panda character designed to remain recognisable across a full picture book, changing environments, emotions and light.', 'Hero + turnaround + expressions + scenes', 'Character definition and consistency', 'ChatGPT Image model, OpenArt, Photoshop', 'Self-initiated concept', '', artwork('/images/showcase/04-character-design/01-story-book-characters/01-popy/openart-gpt-image-2-responses-image_1780255999192_289b454a.png', 'Popy red panda character reference, kitchen environment and storyboard', 'Popy’s Story System', 'A production board connecting a repeatable red-panda design to a warm kitchen world and a five-shot sandwich-making sequence.', 'Turnaround views establish silhouette and markings before the eye moves through environment plans, camera positions and storyboard frames.', 'Honey-gold window light, walnut wood and amber fur create one cohesive story palette across reference and scene work.', 'Design the character, environment and camera language together so Popy remains recognisable when the story moves into action.')),
          project('The Nightingale Cast', 'Literary characters', 'feature', 'A four-character literary system covering the Student, Nightingale, Rose and Professor’s Daughter across a shared story world.', 'Character bible + scene tests', 'Cast design and narrative continuity', 'ChatGPT Image model, OpenArt, Photoshop', 'Self-initiated concept', '', artwork('/images/showcase/04-character-design/01-story-book-characters/02-the-nightingale-cast/openart-gpt-image-2-edit-1_1785516847019_812c51e9.png', 'Photoreal character reference with turnaround, expressions and material details', 'Identity Under Rotation', 'A photoreal reference sheet testing whether one face, haircut and wardrobe system hold across angles, expressions and seated poses.', 'Front, side and back views form the structural anchor; expression crops and material callouts separate identity from styling details.', 'Neutral studio light preserves skin texture, garment construction and colour accuracy without introducing scene-dependent effects.', 'Treat facial proportions, hair shape and material details as production constraints that must survive every new frame.')),
          project('The Curious Chickens', 'Comic ensemble', 'wide', 'A small ensemble designed for recurring humour, distinct personalities and expressive panel compositions.', 'Ensemble sheet + comic scenes', 'Character design and story beats', 'ChatGPT Image model, Photoshop', 'Self-initiated concept', '', artwork('/images/showcase/04-character-design/01-story-book-characters/03-the-curious-chickens/openart-gpt-image-2-edit-1_1785517063065_ec5c7131.png', 'Sunny the curious chicken turnaround and expression sheet', 'Sunny, Ready for Adventure', 'A compact comic-character sheet defining Sunny through a strong headphone silhouette, three expressions and playful listening poses.', 'Orthographic views establish construction while the expression row and larger action poses show how personality changes the same simple body.', 'A restricted black, white and orange-red palette keeps the hand-drawn character readable at panel and sticker scale.', 'Build humour from pose and expression while holding the beak, comb, headphones and graphic feather shapes constant.')),
        ],
      },
      {
        ...
        items: [
          project('Globby', 'Educational mascot', 'square', 'A black planet-like mascot that communicates complex topics through one visual metaphor at a time.', 'Mascot system + applications', 'Concept, expression system and prompts', 'ChatGPT Image model, Illustrator', 'Self-initiated concept', '', artwork('/images/showcase/04-character-design/02-brand-commercial-characters/01-globby/inky.png', 'Globby earth mascot in a series of environmental illustrations', 'Earth’s Inky Illustrations', 'A modular editorial mascot translating climate systems into immediate visual metaphors with very few lines and props.', 'The round black Earth form repeats as the visual anchor while pipes, scales, nets and tools change around it to carry each idea.', 'Mostly monochrome drawing is punctuated by small blue, orange, red and green annotations that direct interpretation.', 'Keep the mascot simple enough to repeat, then let scale, posture and one symbolic object explain each complex topic.')),
          project('NutShell', 'Brand mascot system', 'portrait', 'A friendly savings mascot supported by a clear silhouette, financial prop language, palette and app-scale identity.', 'Mascot identity system', 'Character and brand direction', 'ChatGPT Image model, OpenArt, Illustrator', 'Self-initiated concept', '', artwork('/images/showcase/04-character-design/02-brand-commercial-characters/02-nutshell/openart-gpt-image-2-edit-1_1785516725646_a3693cc3.png', 'NutShell savings mascot turnaround, expressions and material callouts', 'Smart Savings, Friendly Shape', 'An otter mascot system combining a trustworthy silhouette with a gold-coin jar, warm palette and approachable expression range.', 'Front, side and back views define the body and vest before expressions, poses and material callouts test campaign flexibility.', 'Warm browns and cream make the character welcoming; golden yellow concentrates attention on savings-related props and actions.', 'Turn an abstract financial promise into a repeatable character whose silhouette and prop language remain clear at small sizes.')),
          project('Yui', 'Virtual persona', 'portrait', 'A reusable virtual persona maintained across editorial, fashion and product campaign contexts.', 'Persona reference pack + scenes', 'Identity and styling system', 'OpenArt, ChatGPT Image model, Photoshop', 'Self-initiated concept', '', artwork('/images/showcase/04-character-design/02-brand-commercial-characters/03-yui/openart-image_1783000764511_ea505132_1783000764590_c9705e03.png', 'Yui virtual fashion persona editorial identity board', 'Grace in Every Moment', 'An editorial persona board holding the same face and understated manner across colour hero photography and monochrome lifestyle frames.', 'The full-colour central portrait establishes identity while surrounding crops vary angle, gesture and emotional register like a magazine profile.', 'Warm peach fabric and late-afternoon light soften the centre; desaturated supporting frames add memory and editorial restraint.', 'Build a virtual persona through repeatable facial structure and behaviour, not through one perfect portrait alone.')),
        ],
      },
      {
        ...
        items: [
          project('Ink & Cel', 'Anime / manga character sheet', 'wide', 'A cel-shaded character system covering turnaround views, expressions and outfit variations in a consistent manga idiom.', 'Turnaround + expressions + outfits', 'Character design and style control', 'ChatGPT Image model, OpenArt, Photoshop', 'Self-initiated concept', '', artwork('/images/showcase/04-character-design/03-stylised-genre-characters/01-ink-cel/openart-gpt-image-2-edit-1_1785515546441_cc091661.png', 'Black and white illustrated character turnaround and pose sheet', 'Everyday Ink & Cel', 'A clean line-art character system testing a contemporary streetwear design across rotation, expressions and everyday actions.', 'Large turnaround figures provide structural clarity while smaller expression and lifestyle panels demonstrate personality and usable poses.', 'The near-monochrome palette shifts attention to contour, proportion and material contrast instead of decorative colour.', 'Prove that a simple illustrated identity can stay consistent while posture, props and emotional tone change.')),
          project('The Cartographer', 'Game character concept', 'feature', 'A game-character concept developed through silhouette exploration, design passes, prop callouts and colour variants.', 'Concept sheet + callouts', 'Visual development and production design', 'ChatGPT Image model, OpenArt, Photoshop', 'Self-initiated concept', '', artwork('/images/showcase/04-character-design/03-stylised-genre-characters/02-the-cartographer/openart-gpt-image-2-1_1785513807717_d8f21ecb.png', 'Marco football freestyler character concept and turnaround', 'Marco: The Ball Never Drops', 'A sports-character concept combining an expressive action hero, production turnaround and close material details in one presentation sheet.', 'The airborne freestyle pose carries the emotional pitch; neutral orthographic views and equipment crops provide production-ready evidence.', 'Watercolour blue creates speed and atmosphere while orange footwear becomes the repeatable accent across character and prop design.', 'Balance spectacle with specification so the character feels exciting in key art and dependable in subsequent production views.')),
          project('Maya, Defined', 'Professional character system', 'wide', 'A professional identity maintained across reference views, workplace scenes, campaign roles and controlled wardrobe changes.', 'Character CV + consistency board', 'Identity consistency and scene direction', 'ChatGPT Image model, OpenArt, Photoshop', 'Self-initiated concept', '', artwork('/images/showcase/04-character-design/03-stylised-genre-characters/03-maya-defined/ChatGPT Image Jul 19, 2026, 01_46_55 PM.png', 'Professional woman character turnaround, expressions and workplace scenes', 'Professional Identity, Fully Defined', 'A realistic character dossier holding age, facial structure, navy tailoring and restrained accessories across reference and workplace behaviour.', 'The left-side turnaround establishes physical continuity; expressions, desk actions and material crops expand the identity into a believable role.', 'Soft neutral studio light and a disciplined navy-grey palette keep skin, fabric and accessory details consistent across every module.', 'Define professional character through repeatable wardrobe, gesture and behaviour as carefully as facial resemblance.')),
        ],
      },
    ],
  },
