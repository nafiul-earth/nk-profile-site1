  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Browse through CodeBucks' latest articles on web development, React, and more." />
      </Head>
        ...
        <Layout className='pt-16'>
          ...
          <div className='grid grid-cols-2 gap-16 lg:gap-8 md:grid-cols-1 md:gap-y-16'>
            <div className='flex flex-col items-start justify-start'>
              <h2 className='font-bold text-4xl w-full text-center mb-16 lg:text-3xl xs:text-2xl md:text-3xl md:mb-8'>
                Featured Articles
              </h2>
              <ul>
                <FeaturedArticle
                  ...
                  Follow this step-by-step guide to get pagination in your ReactJS project."
                  time="9 min read"
                  link="/"
                ...
                <FeaturedArticle
                  ...
                  summary="Learn how to create stunning loading screens in React with 3 different types of loading screens. 
                  Skeleton screens, spinner loading screens and more."
                  time="10 min read"
                  link="/"
