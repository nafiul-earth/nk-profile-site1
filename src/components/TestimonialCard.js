...
const TestimonialCard = ({ testimonial }) => {
  ...
  return (
    <article className='w-full bg-paper rounded-2xl p-8 border border-ink/15 flex flex-col gap-4 sm:p-6'>
      ...
      <div className='flex items-center gap-3 mt-auto'>
        <span className='w-11 h-11 rounded-full bg-ink text-accent flex items-center justify-center font-bold'>
          {initials}
        </span>
        <div>
